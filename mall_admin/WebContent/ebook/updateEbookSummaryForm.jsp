...
<%
	...
	// 디버깅
		System.out.println(ebookSummary);
...
%>
	...
	<div class="card card-authentication1 mx-auto my-10" style="width: 50rem;">
		<div class="card-body">
		<h5 class="card-title text-uppercase text-center py-3">E-book 요약 수정</h5>
					...
					<table class="table table-hover">
						<tr>
							...
							<td>
								...
								<textarea rows="5" cols="57" name="ebookSummary" required="required" class="form-control input-shadow"></textarea>
							</td>
						</tr>
					</table>
